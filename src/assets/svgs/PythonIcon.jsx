...
export default function PythonIcon({ size = "100%" }) {
  const id = useId(); // generate unique ID for gradients
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={`pythonBlue-${id}`} x1="12.4809" y1="2" x2="12.4809" y2="22.7407" gradientUnits="userSpaceOnUse">
          <stop stopColor="#327EBD" />
          <stop offset="1" stopColor="#1565A7" />
        </linearGradient>
        <linearGradient id={`pythonYellow-${id}`} x1="19.519" y1="9.25928" x2="19.519" y2="30" gradientUnits="userSpaceOnUse">
